...
function App() {
    ...
    const {messages,isLoading, onSubmit, reload, stop , clear} = useChat({ model })
  ...
  return (
    <div className='min-h-vh min-h-svh bg-background font-sans antialiased'>
            <div className='flex flex-col gap-2'>
                <section
                    className='markdown mx-auto  h-[calc(100vh-180px)] w-full overflow-y-auto px-4 py-2 md:px-0 md:py-6'>
                    {messages.length > 0 ? (
